...
function renderHtml(report, extras = {}) {
  ...
  const tableBody = report.rows.map((r, i) => {
    ...
    const cr = r.cacheReadPerM != null ? `$${r.cacheReadPerM.toFixed(3)}` : '—';
...
<div class="wrap">
  ...
  <div class="nums">
    ...
    <div><b>mp/session</b> = session price ÷ quota × 100 000<br><span class="mp-explain">how much of your monthly quota one average task (a full session) eats — higher means more expensive</span></div>
  </div>
  ...
  <div class="scroll">
    <table class="sortable">
      <thead><tr>
        ...
        <th class="num sortable">Multiplier</th><th class="num sortable">Sessions/mo</th>
        <th class="num sortable">Cache-read $/M</th>
